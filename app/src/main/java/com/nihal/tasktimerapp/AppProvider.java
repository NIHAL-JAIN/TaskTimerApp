...
public class AppProvider extends ContentProvider {
    ...
    static final String CONTENT_AUTHORITY = "com.nihal.tasktimerapp.provider";
    ...
    private static UriMatcher buildUriMatcher(){
        ...
        //eg. content://com.nihal.tasktimerapp.provider/Tasks
        matcher.addURI(CONTENT_AUTHORITY,TaskContract.TABLE_NAME, TASKS);
        //eg. content://com.nihal.tasktimerapp.provider/Tasks/8
